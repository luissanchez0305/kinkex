...
class Shopgo_GTM_Block_Gtm extends Mage_Core_Block_Template
{
	...
	protected function _getDataLayer()
	{
		...
		//if (Mage::helper('gtm')->isDataLayerTransactionsEnabled()) $data = $data + $this->_getTransactionData();
		//if (Mage::helper('gtm')->isDataLayerVisitorsEnabled()) $data = $data + $this->_getVisitorData();
