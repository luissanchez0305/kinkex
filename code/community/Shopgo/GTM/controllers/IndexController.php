...
class Shopgo_AjaxLogin_AccountController extends Mage_Customer_AccountController {
    ...
    protected $_customActions = array('loginPopup', 'ajaxLogin', 'ajaxCreate', 'ajaxForgotPassword');
    ...
    public function loginPopupAction() {
        /*
          ...
          $update->load('customer_account_loginpopup');
          $layout->generateXml();
