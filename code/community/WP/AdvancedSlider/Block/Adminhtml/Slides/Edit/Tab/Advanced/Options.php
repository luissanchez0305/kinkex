...
class WP_AdvancedSlider_Block_Adminhtml_Slides_Edit_Tab_Advanced_Options extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('advancedslider_slide_advanced_options', array());
