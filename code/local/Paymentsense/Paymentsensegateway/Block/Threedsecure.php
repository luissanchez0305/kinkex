...
class Paymentsense_Paymentsensegateway_Block_Threedsecure extends Mage_Core_Block_Abstract
{
	/**
	...
	protected function _toHtml()
    {
    	...
    	{
    		$szTermURL = 'paymentsensegateway/payment/callbacktransparentredirect';
    	}
    	else
    	{
    		$szTermURL = 'paymentsensegateway/payment/callback3d';
    	}
